...
!! El siguiente contenido está creado por [@dfleta](https://github.com/dfleta/ricksy-business-observer/blob/master/README.md?plain=1) para espicificar los requisitos a cumplir para completar el examen
